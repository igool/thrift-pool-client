 ...
 * 
 */
package com.github.igool.thrift.client.pool.impl;
 ...
 * 使用guava的functon代替jdk8的function
 * </p>
 *
 * @author w.vela
 * @author igool
...
public final class DefaultThriftConnectionPoolImpl implements ThriftConnectionPoolProvider {
    ...
    public DefaultThriftConnectionPoolImpl(GenericKeyedObjectPoolConfig config) {
    	...
    	this(config,new  Function<ThriftServerInfo, TTransport>() {
			@Override
			public TTransport apply(ThriftServerInfo input) {
				// TODO Auto-generated method stub
				TSocket tsocket = new TSocket(input.getHost(), input.getPort());
