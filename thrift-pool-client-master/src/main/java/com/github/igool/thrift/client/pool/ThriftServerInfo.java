 ...
 * 
 */
package com.github.igool.thrift.client.pool;
...
public final class ThriftServerInfo {
    ...
    public static ThriftServerInfo of(String host, int port) {
        return allInfos.putIfAbsent(host + ":" + port, new ThriftServerInfo(host + ":" + port));
    }

    public static ThriftServerInfo of(String hostAndPort) {
        return allInfos.putIfAbsent(hostAndPort, new ThriftServerInfo(hostAndPort));
    }
